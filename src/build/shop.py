...
T = {
    'el': dict(shop='Κατάστημα', cart='Καλάθι', size='Μέγεθος', color='Χρώμα',
               ...
               ship='Τα ρούχα τυπώνονται κατά παραγγελία από το κατάστημα NeedleWorks και φτάνουν στον προορισμό τους το πολύ σε 15 ημέρες.',
    ...
    'en': dict(shop='Shop', cart='Cart', size='Size', color='Colour',
               ...
               ship='Garments are printed to order by the NeedleWorks shop and reach their destination within 15 days at the latest.',
